#!/bin/bash
#
# TEIKYOUHYOU_KUHEN.PRINT : 提供票印刷
#
# Usage : TEIKYOUHYOU_KUHEN.PRINT
#
...
cat ${tmp}-listdata |
awk '$1=="l"'       |
# 対象事業者のみの利用票(変更＝＞全事業者を表示に変更2014/7/15)
#awk '$10=="'$Jigyoushaid'"'             |
...
awk '{print $2,$3,$4,$5,$6,"_","_",$7,"_","_",$13,$14,$17,"_","_","_","d"}' > ${tmp}-servicecode_houmonkango
# 通所介護
...
# HTMLの作成
cat ${html_dir}/PRINT_TEIKYOUHYOU_KUHEN.html |
...
cat - > $tmp-teikyouhyou_kuhen_base_pdf.html

cp $tmp-teikyouhyou_kuhen_base_pdf.html $work_dir/teikyouhyou_kuhen_base_pdf.html

case "${MODE}" in
  #一括印刷
  allprint )
  /home/hands/E-LIFE/TOOL/wkhtmltopdf-amd64 --orientation Landscape $tmp-teikyouhyou_kuhen_base_pdf.html ${home_dir}/CAREPLAN/DOWNLOAD/IKKATSU_GEKKAN/$USER_ID/${Riyoushaid}_C_${Jigyoushaid}_C_TEIKYOUHYOU_KUHEN.pdf
  ;;
...
# 過去のPDFを一旦消す
rm ${home_dir}/CAREPLAN/DOWNLOAD/${Riyoushaid}/TEIKYOUHYOU_KUHEN.pdf
/home/hands/E-LIFE/TOOL/wkhtmltopdf-amd64 --orientation Landscape $tmp-teikyouhyou_kuhen_base_pdf.html ${home_dir}/CAREPLAN/DOWNLOAD/${Riyoushaid}/TEIKYOUHYOU_KUHEN.pdf
#--------------------------------------------------------------
...
<HTML>
  <HEAD>
    <SCRIPT type="text/javascript" language="Javascript">
      ...
      window.onload=init
      function init(){
           window.open("/E-LIFE/CAREPLAN/DOWNLOAD/${Riyoushaid}/TEIKYOUHYOU_KUHEN.pdf","pdfprint");
           window.self.close();
      }
      //]]>
    </SCRIPT>
