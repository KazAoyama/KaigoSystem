...
//                     ###SERVICETYPE###
        ...
        houmonkaigoextra=[
//                     ###HOUMONKAIGOEXTRA###
                 {"jigyoushatype":"%1","id":"%2","basic":"%3","a":"%4","b":"%5","c":"%6","d":"%7","e":"%8","f":"%9","g":"%10"},
//                     ###HOUMONKAIGOEXTRA###
                ];
...
//　ヘッダー作成
		var htmlhd="<thead><tr><th style=\"text-align:center; border:#bbbbbb solid 1px;width:80px\" rowspan=\"2\">提供時間帯</th><th style=\"text-align:center; border:#bbbbbb solid 1px;width:100px\" rowspan=\"2\">サービス種類</th><th style=\"text-align:center; border:#bbbbbb solid 1px;width:120px\" rowspan=\"2\">サービス事業所名</th><th style=\"text-align:center; border:#bbbbbb solid 1px;\" rowspan=\"2\">サービス内容</th><th style=\"text-align:center; border:#bbbbbb solid 1px;width:3%;\" rowspan=\"2\">保険対象</th><th style=\"text-align:center; border:#bbbbbb solid 1px;width:3%;\" rowspan=\"2\">実績確定</th><th style=\"text-align:center; border:#bbbbbb solid 1px;\" >日付</th>";
...
//　ヘッダー作成
		htmlhd="<thead><tr><th style=\"text-align:center; border:#bbbbbb solid 1px;width:80px\" rowspan=\"2\">提供時間帯</th><th style=\"text-align:center; border:#bbbbbb solid 1px;width:100px\" rowspan=\"2\">サービス種類</th><th style=\"text-align:center; border:#bbbbbb solid 1px;width:150px\" rowspan=\"2\">サービス事業所名</th><th style=\"text-align:center; border:#bbbbbb solid 1px;\" rowspan=\"2\">サービス内容</th><th style=\"text-align:center; border:#bbbbbb solid 1px;width:3%;\" rowspan=\"2\">保険対象</th><th style=\"text-align:center; border:#bbbbbb solid 1px;width:3%;\" rowspan=\"2\">実績確定</th><th style=\"text-align:center; border:#bbbbbb solid 1px;\" >日付</th>";
...
//　供給者選択設定
    		htmlval=htmlval+"<td style=\"text-align:left; border:#bbbbbb solid 1px;\" rowspan=\"2\"><select style=\"width:160px\" id=\"Kyokyusha"+numRecord+"\" name=\"Kyokyusha"+numRecord+"\" class=\"Kyokyusha\"><option value=\"\"</option>";
                var stype="";
...
//　サービス内容設定
    		htmlval=htmlval+"<td style=\"text-align:left; border:#bbbbbb solid 1px;\" rowspan=\"2\"><input type=\"hidden\" id=\"ServiceType"+numRecord+"\" name=\"ServiceType"+numRecord+"\" value=\""+stype+"\" class=\"ServiceType\"><select id=\"ServiceNaiyou"+numRecord+"\" name=\"ServiceNaiyou"+numRecord+"\" style=\"width:140px\" class=\"ServiceNaiyou\">";
...
//　集計単位によって計算が異なる。
		...
		//  通所介護
							if(kaigoservice[g].jigyoushatype==15) {
...
　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　if(kaigoservice[g].servicemanager=="ADD") {
		...
		//  通所リハビリ
							} else if(kaigoservice[g].jigyoushatype==16) {
							    if(kaigoservice[g].kaigodo==youkaigodod[0].kaigodo&&kaigoservice[g].facilitytype=="1"&&(kyoukyusha[k].facilitytype=="4" || kyoukyusha[k].facilitytype=="7")) {
									if(kaigoservice[g].min<=serviceTime&&serviceTime<kaigoservice[g].max) {
										if(kaigoservice[g].id==serviced[s].id){
											servicefee=parseInt(kaigoservice[g].fee);
											serviceshukei=kaigoservice[g].calcunit;
							    ...
							    } else if(kaigoservice[g].kaigodo==youkaigodod[0].kaigodo&&kaigoservice[g].facilitytype=="2"&&(kyoukyusha[k].facilitytype=="5"||kyoukyusha[k].facilitytype=="8")) {
									if(kaigoservice[g].min<=serviceTime&&serviceTime<kaigoservice[g].max) {
										if(kaigoservice[g].id==serviced[s].id){
											servicefee=parseInt(kaigoservice[g].fee);
											serviceshukei=kaigoservice[g].calcunit;
							    ...
							    } else if(kaigoservice[g].kaigodo==youkaigodod[0].kaigodo&&kaigoservice[g].facilitytype=="3"&&(kyoukyusha[k].facilitytype=="6"||kyoukyusha[k].facilitytype=="9")) {
									if(kaigoservice[g].min<=serviceTime&&serviceTime<kaigoservice[g].max) {
										if(kaigoservice[g].id==serviced[s].id){
											servicefee=parseInt(kaigoservice[g].fee);
											serviceshukei=kaigoservice[g].calcunit;
...
　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　if(kaigoservice[g].servicemanager=="ADD") {
		...
		//  訪問介護
                                                             if(kaigoservice[g].scale==kyoukyusha[k].scale&&kaigoservice[g].servicemanager==kyoukyusha[k].servicemanager&&kaigoservice[g].douitsu==kyoukyusha[k].douitsu) {
								if(kaigoservice[g].min<=serviceTime&&serviceTime<kaigoservice[g].max) {
                                                                    if((tmpTimeStart[0]<22&&tmpTimeStart[0]>17)||(tmpTimeStart[0]>5&&tmpTimeStart[0]<8)) {
                                                                      if(kaigoservice[g].asayoru=='2') {
									if(kaigoservice[g].id==serviced[s].id){
                                                                          if(kaigoservice[g].fee=="_"){
                                                                            var KM=serviceTime;
                                                                            var calcKM=KM/30;
                                                                            var taniKM=Math.floor(calcKM);
                                                                            for(var e in houmonkaigoextra) {
                                                                              if(kaigoservice[g].id==houmonkaigoextra[e].id) {
                                                                                 servicefee=Math.round((parseInt(houmonkaigoextra[e].basic)+parseInt(taniKM*houmonkaigoextra[e].a)+parseInt(houmonkaigoextra[e].b))*houmonkaigoextra[e].c*houmonkaigoextra[e].d*houmonkaigoextra[e].e*houmonkaigoextra[e].f*houmonkaigoextra[e].g);
                                                                                 break;
                                                                              }
                                                                            }
                                                                          } else {
                                                                            servicefee=kaigoservice[g].fee;
                                                                          }
									  serviceshukei=kaigoservice[g].calcunit;
                                                                          htmlval=htmlval+"<option value=\""+kaigoservice[g].id+"\" selected>"+kaigoservice[g].value+"</option>";
									} else {
...
　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　if(kaigoservice[g].servicemanager=="ADD") {
                ...
                //  訪問入浴
							} else if(kaigoservice[g].jigyoushatype==12) {
								if(kaigoservice[g].id==serviced[s].id){
									servicefee=parseInt(kaigoservice[g].fee);
									serviceshukei=kaigoservice[g].calcunit;
									htmlval=htmlval+"<option value=\""+kaigoservice[g].id+"\" selected>"+kaigoservice[g].value+"</option>";
...
//  短期入所療養老短
                                                       } else if(kaigoservice[g].jigyoushatype==22) {
                                                         // 日割りのものをまず抽出（時間が設定されているもの）
                                                         if(kaigoservice[g].min=="_"&&kaigoservice[g].max=="_") {
                                                           // 施設区分によって制御
                                            ...
                                            // 時間による制御&&夜間勤務制御
                                                            if(kaigoservice[g].min<=serviceTime&&serviceTime<kaigoservice[g].max&&kaigoservice[g].nightcare==kyoukyusha[k].nightcare) {
                                                              // 欠員は"1"（欠員無し)かそれ以外("1"以外)か
                                                              if(kaigoservice[g].ketsuin=="1"&&kyoukyusha[k].ketsuin=="1") {
                                                                  if(kaigoservice[g].id==serviced[s].id){
                                                                    servicefee=parseInt(kaigoservice[g].fee);
...
//  短期入所療養療養型
                                                       } else if(kaigoservice[g].jigyoushatype==23) {
                                                         // 日割りのものをまず抽出（時間が設定されているもの）
                                                         if(kaigoservice[g].min=="_"&&kaigoservice[g].max=="_") {
                                                           // 施設区分によって制御
                                                           if(kyoukyusha[k].facilitytype==kaigoservice[g].facilitytype) {
		...
		//  訪問リハビリ
							...
							} else if(kaigoservice[g].jigyoushatype==31) {
		//  居宅療養管理
                                                              if(kaigoservice[g].id==serviced[s].id){
                                                                servicefee=parseInt(kaigoservice[g].fee);
					                        serviceshukei=kaigoservice[g].calcunit;
							...
							} else if(kaigoservice[g].jigyoushatype==76) {
		//  定期巡回・随時対応
                                                           if(kaigoservice[g].kaigodo==youkaigodod[0].kaigodo) {
                                                              if(kaigoservice[g].id==serviced[s].id){
                                                                servicefee=parseInt(kaigoservice[g].fee);
							...
							} else if(kaigoservice[g].jigyoushatype==71) {
		//  夜間訪問介護
                                                              if(kaigoservice[g].id==serviced[s].id){
                                                                servicefee=parseInt(kaigoservice[g].fee);
					                        serviceshukei=kaigoservice[g].calcunit;
							...
							} else if(kaigoservice[g].jigyoushatype==72) {
		//  認知通所介護
...
　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　if(kaigoservice[g].servicemanager=="ADD") {
							...
							} else if(kaigoservice[g].jigyoushatype==73) {
		//  小規模多機能
                                                           if(kaigoservice[g].douitsu==kyoukyusha[k].douitsu&&kaigoservice[g].kaigodo==youkaigodod[0].kaigodo&&kaigoservice[g].ketsuin==kyoukyusha[k].ketsuin) {
                                                              if(kaigoservice[g].id==serviced[s].id){
                                                                servicefee=parseInt(kaigoservice[g].fee);
					                        serviceshukei=kaigoservice[g].calcunit;
                                                                htmlval=htmlval+"<option value=\""+kaigoservice[g].id+"\" selected>"+kaigoservice[g].value+"</option>";
							...
							} else if(kaigoservice[g].jigyoushatype==32) {
		//  認知症対応型（短期利用以外）
                                                           if(kaigoservice[g].kaigodo==youkaigodod[0].kaigodo&&kaigoservice[g].ketsuin==kyoukyusha[k].ketsuin) {
                                                              if(kaigoservice[g].id==serviced[s].id){
                                                                servicefee=parseInt(kaigoservice[g].fee);
							...
							} else if(kaigoservice[g].jigyoushatype==38) {
		//  認知症対応型（短期利用）
                                                           if(kaigoservice[g].kaigodo==youkaigodod[0].kaigodo&&kaigoservice[g].ketsuin==kyoukyusha[k].ketsuin) {
                                                              if(kaigoservice[g].id==serviced[s].id){
                                                                servicefee=parseInt(kaigoservice[g].fee);
							...
							} else if(kaigoservice[g].jigyoushatype==77) {
		//  認知症対応型（短期利用）
                                                           if(kaigoservice[g].kaigodo==youkaigodod[0].kaigodo&&kaigoservice[g].ketsuin==kyoukyusha[k].ketsuin) {
                                                              if(kaigoservice[g].id==serviced[s].id){
                                                                servicefee=parseInt(kaigoservice[g].fee);
...
//  レンタルの場合は自動的に1日に"1"がつく
                                if(serviced[s].jigyoushatype=="17"&&yd=="1") {
                                     htmlval=htmlval+"<td style=\"text-align:center; border:#bbbbbb solid 1px;\"><input type=\"text\" value=\"1\" id=\"riyou"+serviced[s].id+yd+"\" name=\"RiyouYotei\" class=\"Riyou"+yd+"\" style=\"width:100%;\"></td>";
                                     flg="1";
                                     kaisu++;
                                }
...
//  単位が保存されている場合はそちらを優先（4/10）
                        if(serviced[s].firsttani!=""&&serviced[s].firsttani!="_") {
			...
			htmlval=htmlval+"<td style=\"text-align:center; border:#bbbbbb solid 1px;\" class=\"JissekiGoukei\">0</td><input type=\"hidden\"id=\"hdJissekiGoukei"+numRecord+"\" name=\"hdJissekiGoukei"+numRecord+"\" class=\"hdJissekiGoukei\" ><td style=\"text-align:center; border:#bbbbbb solid 1px;\" class=\"JissekiTaniGoukei\">0</td><td style=\"text-align:center; border:#bbbbbb solid 1px;display:none\" class=\"JissekiFuzuiGoukei\">0</td><input type=\"hidden\" id=\"RiyouJissekiVal"+numRecord+"\" name=\"RiyouJissekiVal"+numRecord+"\">";
			htmlval=htmlval+"</tr>";
			yoteigoukei=0;
                        yoteifuzui=0;
                ...
                $('.ServiceNaiyou').live('change',function() {
                   ...
                   for(k in kaigoservice) {
                      if(kaigoservice[k].id==snid&&kaigoservice[k].jigyoushatype==servicetype) {
                        if(kaigoservice[k].jigyoushatype=="11"&&kaigoservice[k].fee=="_"){
                           var ST=$(".teikyoujikanstart").eq(snidx).val().split(":");
                           var ET=$(".teikyoujikanend").eq(snidx).val().split(":");
                           var SM=ST[0]*60+parseInt(ST[1]);
                           var EM=ET[0]*60+parseInt(ET[1]);                           
                           var KM=parseInt(EM)-parseInt(SM);
                           var calcKM=KM/30;
                           var taniKM=Math.floor(calcKM);
                           for(var e in houmonkaigoextra) {
                             if(kaigoservice[k].id==houmonkaigoextra[e].id) {
                               servicefee=Math.round((parseInt(houmonkaigoextra[e].basic)+parseInt(taniKM*houmonkaigoextra[e].a)+parseInt(houmonkaigoextra[e].b))*houmonkaigoextra[e].c*houmonkaigoextra[e].d*houmonkaigoextra[e].e*houmonkaigoextra[e].f*houmonkaigoextra[e].g);
                               break;
                             }
                          }
                         ...
                         $('.calcUnit').eq(snidx).val(kaigoservice[k].calcunit);
                         break;
                      }
                   }
                });
...
//　集計（サービス単位×回数）
                        var goukeikingaku=0;
//  単位が保存されている場合はそちらを優先（4/10）
                        if(sakuseid[s].firsttani!=""&&sakuseid[s].firsttani!="_") {
			...
			htmlval=htmlval+"<td style=\"text-align:center; border:#bbbbbb solid 1px;\" class=\"YoteiGoukei\">"+kaisu+"</td><td style=\"text-align:center; border:#bbbbbb solid 1px;\" rowspan=\"2\"><input type=\"hidden\"id=\"hdYoteiGoukei"+numRecord+"\" name=\"hdYoteiGoukei"+numRecord+"\" class=\"hdYoteiGoukei\" value=\""+kaisu+"\"><input type=\"hidden\" id=\"calcUnit"+numRecord+"\" name=\"calcUnit"+numRecord+"\" class=\"calcUnit\" value=\""+serviceshukei+"\"><input type=\"text\" id=\"ServiceTani"+numRecord+"\" name=\"ServiceTani"+numRecord+"\" style=\"width:40px\" class=\"ClServiceTani\" value=\""+servicefee+"\" ></td><td style=\"text-align:center; border:#bbbbbb solid 1px;\" class=\"YoteiTaniGoukei\">"+goukeikingaku+"</td><td style=\"text-align:center; border:#bbbbbb solid 1px;\" rowspan=\"2\" ><input type=\"text\" name=\"HiwariStart"+numRecord+"\" style=\"width:30px\">～<input type=\"text\" name=\"HiwariEnd"+numRecord+"\" style=\"width:30px\"></td><td style=\"text-align:center; border:#bbbbbb solid 1px;display:none\" rowspan=\"2\"><input type=\"text\" id=\"FuzuiHiyou"+numRecord+"\" name=\"FuzuiHiyou"+numRecord+"\" style=\"width:40px\" class=\"ClFuzuiHiyou\" value=\""+sakuseid[s].plusfee+"\" ></td><td style=\"text-align:center; border:#bbbbbb solid 1px;display:none\" class=\"YoteiFuzuiGoukei\">"+pluskingaku+"</td><input type=\"hidden\" id=\"RiyouYoteiVal"+numRecord+"\" name=\"RiyouYoteiVal"+numRecord+"\">";
			htmlval=htmlval+"</tr><tr class=\"trjisseki\">";
...
//  通所介護
					if(kaigoservice[ks].jigyoushatype==15) {
...
//  通所リハビリ
					} else if(kaigoservice[ks].jigyoushatype==16) {
					    if(kaigoservice[ks].kaigodo==youkaigodod[0].kaigodo&&kaigoservice[ks].facilitytype=="1"&&(JigyoushaFacilityType=="4"||JigyoushaFacilityType=="7")) {
							if(kaigoservice[ks].min<=KikanMinutes&&KikanMinutes<kaigoservice[ks].max) {
							    $('.ServiceNaiyou').eq(idx).append("<option value=\""+kaigoservice[ks].id+"\">"+kaigoservice[ks].value+"</option>");
							}
					    } else if(kaigoservice[ks].kaigodo==youkaigodod[0].kaigodo&&kaigoservice[ks].facilitytype=="2"&&(JigyoushaFacilityType=="5"||JigyoushaFacilityType=="8")) {
							if(kaigoservice[ks].min<=KikanMinutes&&KikanMinutes<kaigoservice[ks].max) {
							    $('.ServiceNaiyou').eq(idx).append("<option value=\""+kaigoservice[ks].id+"\">"+kaigoservice[ks].value+"</option>");
							}
					    } else if(kaigoservice[ks].kaigodo==youkaigodod[0].kaigodo&&kaigoservice[ks].facilitytype=="3"&&(JigyoushaFacilityType=="6"||JigyoushaFacilityType=="9")) {
							if(kaigoservice[ks].min<=KikanMinutes&&KikanMinutes<kaigoservice[ks].max) {
							    $('.ServiceNaiyou').eq(idx).append("<option value=\""+kaigoservice[ks].id+"\">"+kaigoservice[ks].value+"</option>");
							}
                                            } else {
...
　　　　　　　　　　　　　　　　　　　　　　　  if(kaigoservice[ks].servicemanager=="ADD") {
					...
					} else if(kaigoservice[ks].jigyoushatype==12) {
//  訪問入浴
					    $('.ServiceNaiyou').eq(idx).append("<option value=\""+kaigoservice[ks].id+"\">"+kaigoservice[ks].value+"</option>");						
...
//  短期入所療養老短
                                        } else if(kaigoservice[ks].jigyoushatype==22) {
                                           // 日割りのものをまず抽出（時間が設定されているもの）
                                           if(kaigoservice[ks].min=="_"&&kaigoservice[ks].max=="_") {
                                             // 施設区分によって制御
                                            ...
                                            // 時間による制御&&夜間勤務制御
                                            if(kaigoservice[ks].min<=KikanMinutes&&KikanMinutes<kaigoservice[ks].max&&kaigoservice[ks].nightcare==nightcare) {
                                                // 欠員は"1"（欠員無し)かそれ以外("1"以外)か
                                                if(kaigoservice[ks].ketsuin=="1"&&ketsuin=="1") {
                                                  $('.ServiceNaiyou').eq(idx).append("<option value=\""+kaigoservice[ks].id+"\">"+kaigoservice[ks].value+"</option>");
                                                } else if (kaigoservice[ks].ketsuin!="1"&&ketsuin!="1") {
...
//  短期入所療養老短
                                        } else if(kaigoservice[ks].jigyoushatype==23) {
                                           // 日割りのものをまず抽出（時間が設定されているもの）
                                           if(kaigoservice[ks].min=="_"&&kaigoservice[ks].max=="_") {
                                             // 施設区分によって制御
                                             if(JigyoushaFacilityType==kaigoservice[ks].facilitytype) {
...
//  居宅療養管理
                                        } else if(kaigoservice[ks].jigyoushatype==31) {
                                                $('.ServiceNaiyou').eq(idx).append("<option value=\""+kaigoservice[ks].id+"\">"+kaigoservice[ks].value+"</option>");
//  定期巡回・随時対応
                                        } else if(kaigoservice[ks].jigyoushatype==76) {
                                            if(kaigoservice[ks].kaigodo==youkaigodod[0].kaigodo) {
                                                $('.ServiceNaiyou').eq(idx).append("<option value=\""+kaigoservice[ks].id+"\">"+kaigoservice[ks].value+"</option>");
                                            }
//  夜間訪問介護
                                        } else if(kaigoservice[ks].jigyoushatype==71) {
                                                $('.ServiceNaiyou').eq(idx).append("<option value=\""+kaigoservice[ks].id+"\">"+kaigoservice[ks].value+"</option>");
//  認知通所介護
                                        } else if(kaigoservice[ks].jigyoushatype==72) {
...
//  小規模多機能
                                        } else if(kaigoservice[ks].jigyoushatype==73) {
                                            if(kaigoservice[ks].douitsu==douitsu&&kaigoservice[ks].kaigodo==youkaigodod[0].kaigodo&&kaigoservice[ks].ketsuin==ketsuin) {
                                                $('.ServiceNaiyou').eq(idx).append("<option value=\""+kaigoservice[ks].id+"\">"+kaigoservice[ks].value+"</option>");
                                            }
//  認知症対応型（短期利用以外）
                                        } else if(kaigoservice[ks].jigyoushatype==32) {
                                            if(kaigoservice[ks].kaigodo==youkaigodod[0].kaigodo&&kaigoservice[ks].ketsuin==ketsuin) {
                                                $('.ServiceNaiyou').eq(idx).append("<option value=\""+kaigoservice[ks].id+"\">"+kaigoservice[ks].value+"</option>");
                                            }
//  認知症対応型（短期利用）
                                        } else if(kaigoservice[ks].jigyoushatype==38) {
                                            if(kaigoservice[ks].kaigodo==youkaigodod[0].kaigodo&&kaigoservice[ks].ketsuin==ketsuin) {
                                                $('.ServiceNaiyou').eq(idx).append("<option value=\""+kaigoservice[ks].id+"\">"+kaigoservice[ks].value+"</option>");
                                            }
//  複合型
                                        } else if(kaigoservice[ks].jigyoushatype==77) {
                                            if(kaigoservice[ks].kaigodo==youkaigodod[0].kaigodo&&kaigoservice[ks].ketsuin==ketsuin) {
                                                $('.ServiceNaiyou').eq(idx).append("<option value=\""+kaigoservice[ks].id+"\">"+kaigoservice[ks].value+"</option>");
                                            }
                                        } else {
...
//　時間や規模などに関係ない項目
			...
			for (var kn in kaigoservice) {
                 if($('.ServiceNaiyou').eq(idx).children(':selected').val()==kaigoservice[kn].id&&JigyoushaType==kaigoservice[kn].jigyoushatype) {
                     ...
                     $('.calcUnit').eq(idx).val(kaigoservice[kn].calcunit);
                     break;
                 }
            }
        }
...
//  追加ボタンがクリックされた場合、行を１行増やす
        ...
        function addRiyouhyouRecord() {
    		...
    		addHtmlHd1field2=addHtmlHd1field2+"<td style=\"text-align:left; border:#bbbbbb solid 1px;\" rowspan=\"2\"><select style=\"width:160px\" id=\"Kyokyusha"+numRecord+"\" name=\"Kyokyusha"+numRecord+"\" class=\"Kyokyusha\"><option value=\"\"></option>";
    		for (var k in kyoukyusha) {
				addHtmlHd1field2=addHtmlHd1field2+"<option value=\""+kyoukyusha[k].id+"\">"+kyoukyusha[k].value+"</option>";
			}
    		addHtmlHd1field2=addHtmlHd1field2+"</select></td>";
            var addHtmlHd1field3="<td style=\"text-align:left; border:#bbbbbb solid 1px;\" rowspan=\"2\"><input type=\"hidden\" id=\"ServiceType"+numRecord+"\" name=\"ServiceType"+numRecord+"\" class=\"ServiceType\"><select id=\"ServiceNaiyou"+numRecord+"\" name=\"ServiceNaiyou"+numRecord+"\" style=\"width:140px\" class=\"ServiceNaiyou\"></select>";
...
//  日データ
            ...
            var addHtmlHd1field6="<td style=\"text-align:center; border:#bbbbbb solid 1px;\" rowspan=\"2\"><input type=\"hidden\" id=\"hdYoteiGoukei"+numRecord+"\" name=\"hdYoteiGoukei"+numRecord+"\" class=\"hdYoteiGoukei\"/><input type=\"hidden\" id=\"calcUnit"+numRecord+"\" name=\"calcUnit"+numRecord+"\" class=\"calcUnit\"><input type=\"text\" id=\"ServiceTani"+numRecord+"\" name=\"ServiceTani"+numRecord+"\" style=\"width:40px\" class=\"ClServiceTani\" value=\"0\"></td>";
		...
		<table style="margin-left:2em;min-width:1024px;"><tr>
			...
			<td style="text-align:right;">
				<div class="btn-toolbar">
	            	<button id="regist" class="btn btn-pink" type="button" style="display:###TOUROKUDISP###" ###TOUROKUDISABLED### /><i class="icon-edit"></i> 登録</button>
		        	<button id="print" class="btn btn-green" type="button" style="display:###PRINTDISP###" /><i class="icon-print"></i> 印刷</button>
